...
import os
MODEL_WEIGHTS_FILE = 'question_pairs_weights.h5' #weight parameter file to save
data = pd.read_csv("train.csv") #test adn train data to read
...
##
MODEL_WEIGHTS_FILE = 'quepair_weights_super(32_25_prelu).h5'
print("Starting training at", datetime.datetime.now())
t0 = time.time()
callbacks = [ModelCheckpoint(MODEL_WEIGHTS_FILE, monitor='val_accuracy', save_best_only=True)]
